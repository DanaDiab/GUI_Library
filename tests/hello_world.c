...
int main(int argc, char** argv)
{
	...
	window_fils = ei_widget_create	("toplevel", window, NULL, NULL);
	...
	ei_toplevel_configure		(window_fils, &(ei_size_t){160,120},
					      	 &(ei_color_t){0,0,0,50},
						 &(int){2},
						 &(ei_string_t){"Hey World"}, NULL, NULL, NULL);
	ei_place_xy			(window_fils, 30, 10);
